...
'''Чтобы логи сохранялись, необходимо добавить в file_name путь к папке. Добавил этот файл для шаблона, чтобы его
можно было использовать. В дальнейшем, можно добавить его в gitignore, чтобы каждый раз не изменялся путь к папке'''


class Logger():
    file_name = "C:\\Users\\Эмиль\\pythonProject\\Test_Project\\logs\\log_" \
